...
class _SingleProductDetailPageState extends State<SingleProductDetailPage> {
  ...
  bool _isUpdateValid() {
    ...
    if (_formKey.currentState.validate()) {
      ...
      print(widget.input.product.description);
          ...
          return Container(
            ...
            child: CupertinoPicker(
                ...
                onSelectedItemChanged: (int index) {
                  setState(() {
                    if (MeasureUnitList.units[index].toString() ==
                        "nessun valore") {
                      _measureUnit = "";
                      _measureController.text = _measureUnit;
                    } else {
                      _measureUnit = MeasureUnitList.units[index].toString();
                      _measureController.text = _measureUnit;
                    }
                  });

...
class SingleProductInsertShownIput {
  String menuId;
  String workspaceId;
  String ricettaId;
  String color;
  SingleProductInsertShownIput(
      this.menuId, this.workspaceId, this.ricettaId, this.color);
}

class SingleProductInsertShowWidget extends StatefulWidget {
  final SingleProductInsertShownIput input;

  const SingleProductInsertShowWidget(this.input);
  @override
  SingleProductInsertWidgetState createState() =>
      SingleProductInsertWidgetState();
}

class SingleProductInsertWidgetState
    extends State<SingleProductInsertShowWidget> {
...
//date
  ...
  void _saveProduct() async {
    ...
    if (_formKey.currentState.validate()) {
      ...
      _product.color = widget.input.color;
      _product.ricettaIdRef = widget.input.ricettaId;
      await DatabaseService.instance.insertProductOnReceipt(
          widget.input.menuId,

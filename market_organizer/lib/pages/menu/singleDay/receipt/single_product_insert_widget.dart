...
class SingleProductInsertInput {
  Function
      insertNewProduct; //gestisco sia insert che update di prodotto NON ancora salvato a db
  String workspaceId;
  SingleProductInsertInput(this.insertNewProduct, this.workspaceId);
}

class SingleProductInsertWidget extends StatefulWidget {
  final SingleProductInsertInput input;

  const SingleProductInsertWidget(this.input);
  @override
  SingleProductInsertWidgetState createState() =>
      SingleProductInsertWidgetState();
}

class SingleProductInsertWidgetState extends State<SingleProductInsertWidget> {
